...
export default function CableTvSearch(props) {
  return (
    <div
      id="searchBar"
      className="hidden items-center lg:gap-1 md:gap-0.5 gap-px w-full bg-gray-100 lg:px-3 md:px-2 px-1 lg:text-xl md:text-base text-sm lg:rounded-xl md:rounded-md rounded lg:mb-3 md:mb-1.5 mb-0.5"
    >
      ...
      <input
        ...
        className="outline-none grow bg-gray-100 lg:py-4 md:py-2 py-1"
        onChange={(e) => {
